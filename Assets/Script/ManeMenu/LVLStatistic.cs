...
public class LVLStatistic : MonoBehaviour
{
	...
	{
		if (lastCoinsInGame <= 10)
		{
			actualCoinsTMP.text = "0" + lastCoinsInGame.ToString();
		}
		else
		{
		...
		if (lastMinutsInGame <= 10)
		{
			actualMinutsTMP.text = "0" + lastMinutsInGame.ToString();
		}
		else
		{
		...
		if (lastSecundsInGame <= 10)
		{
			actualSecundTMP.text = "0" + lastSecundsInGame.ToString();
		}
		else
		{
